@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}">
        ...
        <div class="flex flex-col sm:flex-row flex-1 gap-4 sm:gap-2 items-center justify-between">
            ...
            <div>
                <span class="inline-flex flex-wrap justify-center rtl:flex-row-reverse shadow-sm rounded-md">
