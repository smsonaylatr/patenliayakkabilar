        ...
        <div x-show="open"
            ...
            <div class="flex-shrink-0 px-4 pt-3 border-t border-gray-100 bg-white" style="padding-bottom: calc(1.25rem + env(safe-area-inset-bottom, 0px));">
                <a href="{{ route('products.index') }}"
                   @click="open = false"
                   wire:navigate
                   class="flex items-center justify-center gap-2 w-full px-4 py-4 rounded-2xl bg-black text-white font-semibold text-sm uppercase tracking-widest hover:bg-gray-900 transition-colors">
                    <svg class="w-5 h-5" viewBox="0 0 21 20" fill="none" stroke="currentColor" stroke-width="1.5">
