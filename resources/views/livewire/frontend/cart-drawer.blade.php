                                    ...
                                    @foreach($items as $index => $item)
                                        <li class="flex gap-4 md:gap-6 {{ $index > 0 ? 'pt-4 md:pt-6 border-t border-black/[0.06]' : '' }} pb-4 md:pb-6">
                                            ...
                                            <div class="shrink-0 flex flex-col items-end justify-between" style="min-height:80px;">
                                                ...
                                                <button wire:click="removeItem({{ $item->id }})" class="p-1.5 -ml-px text-black/30 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all" title="Kaldır" aria-label="Ürünü sepetten kaldır">
