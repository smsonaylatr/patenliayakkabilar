                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                            <p class="text-slate-600 font-medium text-lg sm:col-span-8 md:col-span-7 lg:col-span-8">+90 (850) 307 31 64</p>
                            <div class="sm:col-span-4 md:col-span-5 lg:col-span-4 flex justify-start">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                            <p class="text-slate-600 font-medium text-[17px] sm:text-lg sm:col-span-8 md:col-span-7 lg:col-span-8">patenliayakkabilar@gmail.com</p>
                            <div class="sm:col-span-4 md:col-span-5 lg:col-span-4 flex justify-start">
