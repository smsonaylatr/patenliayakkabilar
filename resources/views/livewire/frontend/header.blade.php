        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 sm:h-20 relative">
                ...
                <div class="flex flex-1 items-center justify-end space-x-4 md:space-x-6">
                    <button x-data @click="$dispatch('open-search')" aria-label="Arama Yap" class="hidden md:flex text-gray-900 hover:text-black hover:bg-black/5 active:scale-90 rounded-full transition-all duration-200 p-2.5 min-w-[44px] min-h-[44px] items-center justify-center group">
                        <svg class="h-6 w-6 transition-transform duration-300 group-hover:scale-110 group-active:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
