        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex flex-1 items-center justify-end space-x-4 md:space-x-6">
                    ...
                    <a href="{{ auth()->check() ? route('account.dashboard') : route('login') }}" class="text-gray-900 hover:text-gray-500 transition-colors hidden sm:block" title="Hesabım" wire:navigate>
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
