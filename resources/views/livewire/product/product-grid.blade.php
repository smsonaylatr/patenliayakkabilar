    ...
    @forelse($products as $product)
        ...
        >
            <div class="relative w-full aspect-square bg-transparent rounded-2xl shadow-sm transition-all duration-500 group-hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)]" style="perspective: 1000px;">
                ...
                @endphp
                @if($sizes->isNotEmpty())
                    <div class="absolute top-2 right-2 z-40 bg-white/70 backdrop-blur-md text-gray-700 text-[11px] font-bold tracking-wide px-2 py-1 rounded-lg shadow-sm border border-white/40 pointer-events-none transition-all duration-300 group-hover:opacity-0">
