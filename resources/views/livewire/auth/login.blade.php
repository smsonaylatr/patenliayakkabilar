        ...
        <div class="bg-white/90 backdrop-blur-2xl border border-white/60 rounded-2xl sm:rounded-3xl p-4 sm:p-7 md:p-8 shadow-[0_15px_35px_rgba(0,0,0,0.06)] sm:shadow-[0_30px_60px_rgba(0,0,0,0.08)] relative overflow-hidden">
            ...
            <form wire:submit="login" class="space-y-3.5 sm:space-y-4 relative z-10">
                ...
                <div class="space-y-1">
                    <div class="flex items-center justify-between ml-1">
                        ...
                        <a wire:navigate href="{{ route('password.request') }}" class="text-[11px] sm:text-xs text-brand-blue hover:underline">Şifremi Unuttum</a>
                    </div>
            ...
            <div class="mt-5 sm:mt-7 relative z-10">
                ...
                <div class="mt-4 sm:mt-5">
                    <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center px-3.5 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-xl shadow-xs bg-white text-xs sm:text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors">
