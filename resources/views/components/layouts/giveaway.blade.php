        ...
        <div class="max-w-6xl mx-auto px-3.5 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" 
                   class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider px-3.5 py-2 rounded-md bg-black text-white hover:bg-gray-800 transition-colors">
