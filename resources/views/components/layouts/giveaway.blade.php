    ...
    <header class="w-full bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="/" class="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-gray-800 hover:text-black transition-colors py-2 px-3.5 rounded-lg border border-gray-200 hover:bg-gray-100">
