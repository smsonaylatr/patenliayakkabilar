                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 sm:gap-8 mb-8 sm:mb-12">
                        <div class="col-span-2">
                            ...
                            <div class="mt-4 sm:mt-5">
                                <a href="https://etbis.ticaret.gov.tr/tr/SiteSorgulamaSonuc?siteId={{ config('services.etbis.site_id') }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2.5 group bg-white/[0.04] hover:bg-white/[0.08] border border-gray-800 hover:border-gray-700 rounded-lg py-1.5 px-3 transition-colors">
