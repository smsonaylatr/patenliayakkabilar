...
<html lang="tr" dir="ltr">
    ...
    <body class="bg-brand-light text-brand-dark font-sans antialiased flex flex-col min-h-screen overflow-x-hidden">
        ...
        <a href="tel:08503073164" class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 text-white rounded-full shadow-2xl hover:scale-110 hover:brightness-125 transition-all duration-300 group" style="background-color: #0B132B;" aria-label="Bizi Arayın">
            ...
            <!-- Tooltip -->
            <span class="absolute right-16 top-1/2 -translate-y-1/2 text-white text-[11px] font-bold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-xl pointer-events-none tracking-wide" style="background-color: #0B132B;">
                Bizi Arayın
            </span>
        </a>
