...
<html lang="tr" dir="ltr">
    ...
    <body class="bg-brand-light text-brand-dark font-sans antialiased flex flex-col min-h-screen overflow-x-hidden">
        ...
        <!-- Mobile Bottom Navigation Bar — Halikoy Senkronize -->
        <div class="md:hidden fixed inset-x-0 bottom-0 w-full z-[9999]" style="padding-bottom: env(safe-area-inset-bottom); transform: translateZ(0);">
            <div class="bg-white rounded-t-[20px] shadow-[0_-1px_12px_rgba(0,0,0,0.06)]">
                <div class="flex items-center justify-around h-[62px] w-full px-1">
                    
                    {{-- 1. Anasayfa --}}
                    <a href="{{ route('home') }}" wire:navigate class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full">
                        ...
                        <span class="text-[10px] leading-none text-black/80">Anasayfa</span>
                    </a>

                    {{-- 2. Menü --}}
                    <button x-data @click="$dispatch('open-mobile-menu')" class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full">
                        <svg class="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" d="M3 6H21M3 12H11M3 18H16"/>
                        </svg>
                        <span class="text-[10px] leading-none text-black/80">Menü</span>
                    </button>

                    {{-- 3. Arama --}}
                    <button x-data @click="$dispatch('open-search')" class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full">
                        <svg class="w-[22px] h-[22px]" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18.4007 17.4998L15.3707 14.4698M15.3707 14.4698C16.7279 13.1126 17.5674 11.2376 17.5674 9.1665C17.5674 5.02437 14.2095 1.6665 10.0674 1.6665C5.92525 1.6665 2.56738 5.02437 2.56738 9.1665C2.56738 13.3086 5.92525 16.6665 10.0674 16.6665C12.1385 16.6665 14.0135 15.827 15.3707 14.4698Z"/>
                        </svg>
                        <span class="text-[10px] leading-none text-black/80">Arama</span>
                    </button>

                    {{-- 4. Tüm Ürünler --}}
                    <a href="{{ route('products.index') }}" wire:navigate class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full">
                        ...
                        <span class="text-[10px] leading-none text-black/80 whitespace-nowrap">Tüm Ürünler</span>
                    </a>

                    {{-- 5. Sepetim --}}
                    <button x-data @click="$dispatch('toggle-cart')" class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full relative">
                        <div class="relative">
                            <svg class="w-[22px] h-[22px]" viewBox="0 0 21 20" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="absolute -top-1 -right-2 bg-black text-white text-[8px] font-bold min-w-[14px] h-[14px] flex items-center justify-center rounded-full leading-none cart-badge-count" style="display: none;"></span>
                        </div>
                        <span class="text-[10px] leading-none text-black/80">Sepetim</span>
                    </button>

                    {{-- 6. Hesabım --}}
                    <a href="{{ auth()->check() ? route('account.dashboard') : route('login') }}" wire:navigate class="flex flex-col items-center justify-center gap-[6px] text-black/80 active:text-black transition-colors w-full">
                        <svg class="w-[22px] h-[22px]" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
                            <rect x="5.5" y="1.3335" width="9" height="9" rx="4.5"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10 12.917C11.25 12.917 13.3333 13.1948 13.75 13.3337C14.1667 13.4725 16.8333 14.0003 17.5 15.0003C18.3333 16.2503 18.3333 16.667 18.3333 18.3337"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10 12.917C8.75 12.917 6.66667 13.1948 6.25 13.3337C5.83333 13.4725 3.16667 14.0003 2.5 15.0003C1.66667 16.2503 1.66667 16.667 1.66667 18.3337"/>
                        </svg>
                        <span class="text-[10px] leading-none text-black/80">Hesabım</span>
                    </a>
