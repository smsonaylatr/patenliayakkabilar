                ...
                <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 sm:gap-8 mb-8 sm:mb-12">
                        <div class="col-span-2">
                            ...
                            <div class="mt-4 sm:mt-6 flex flex-wrap items-center gap-3.5 sm:gap-6">
                                <!-- Social Icons -->
                                ...
                                <div>
                                    <a href="https://etbis.ticaret.gov.tr/tr/SiteSorgulamaSonuc?siteId={{ config('services.etbis.site_id') }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 sm:gap-3 group bg-white/5 border border-gray-800 rounded-lg py-1.5 px-2.5 sm:py-2 sm:px-3 hover:bg-white/10 transition-colors">
                                        <div class="bg-green-500/10 p-1 sm:p-1.5 rounded-md flex-shrink-0">
                                        ...
                                        <div class="flex flex-col text-left">
                                            <span class="text-[11px] sm:text-xs font-black text-white tracking-wider leading-none mb-0.5 sm:mb-1">ETBİS</span>
                                            <span class="text-[9px] sm:text-[10px] font-medium text-gray-400 leading-none">Güvenli E-Ticaret</span>
                                        </div>
                                    </a>
                                </div>
                                @endif
