                ...
                <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 sm:gap-8 mb-8 sm:mb-12">
                        <div class="col-span-2">
                            <div class="flex flex-wrap items-center gap-3 sm:gap-4 mb-2.5 sm:mb-4">
                                <a href="{{ route('home') }}" class="text-xl sm:text-2xl font-black text-white tracking-tighter inline-block" wire:navigate>
                                    PATENLİ<span class="font-light">AYAKKABILAR&reg;</span>
                                </a>

                                <!-- ETBIS Seal (Right of Logo) -->
                                @if(config('services.etbis.site_id'))
                                <a href="https://etbis.ticaret.gov.tr/tr/SiteSorgulamaSonuc?siteId={{ config('services.etbis.site_id') }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2.5 group bg-white/[0.04] hover:bg-white/[0.08] border border-gray-800 hover:border-gray-700 rounded-lg py-1.5 px-5 transition-colors">
                            ...
                            <p class="text-xs sm:text-sm text-gray-400 max-w-md leading-relaxed">{{ $footerDesc }}</p>
