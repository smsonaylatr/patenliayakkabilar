                ...
                <div class="grid grid-cols-6 h-[76px] w-full px-2 py-2">
                    ...
                    <button x-data="{ 
                        ...
                        <div class="relative">
                            ...
                            <span x-show="count > 0" x-text="count" class="absolute -top-1 -right-2 min-w-[16px] h-[16px] flex items-center justify-center bg-[#ff3b5c] text-white text-[9px] font-bold rounded-full px-0.5 leading-none shadow-sm" style="display: none;"></span>
                        </div>
