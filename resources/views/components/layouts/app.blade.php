                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                        <div class="col-span-2">
                            ...
                            <div class="mt-6 flex items-center space-x-6">
                                ...
                                <a href="tel:08503073164" class="flex items-center justify-center w-12 h-12 text-white rounded-full shadow-lg hover:scale-110 hover:brightness-125 transition-all duration-300" style="background-color: #0B132B;" aria-label="Bizi Arayın" title="Bizi Arayın">
