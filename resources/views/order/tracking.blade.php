    ...
    <div class="min-h-[70vh] bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
                ...
                <p class="text-gray-500 mb-8 text-sm">Siparişinizin durumunu ve Porego / DHL kargo takip kodunuzu öğrenmek için sipariş numaranızı girin.</p>
                ...
                @if(isset($order))
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100 text-left">
                        ...
                        <div class="bg-gray-50 rounded-2xl p-5 space-y-4 border border-gray-100">
                            ...
                            <!-- POREGO / DHL KARGO TAKİP KODU ALANI -->
                            <div class="bg-white p-4 rounded-xl border border-gray-200 space-y-3 mt-2">
                                <div class="flex justify-between items-center">
                                    <span class="text-xs font-bold uppercase tracking-wider text-gray-500">{{ $cargoName }} Takip Kodu</span>
                                    <span class="inline-flex items-center gap-1 text-xs text-emerald-600 font-bold">
                                        <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Kargo Aktif
                                    </span>
                                </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <div x-data="{ copied: false }" @click="navigator.clipboard.writeText('{{ e($trackingCode) }}'); copied = true; setTimeout(() => copied = false, 2000)" class="cursor-pointer bg-gray-100 hover:bg-black hover:text-white text-gray-800 text-xs font-bold px-3 py-2 rounded-lg transition-colors flex items-center gap-1 shadow-sm">
                                        ...
                                        <a href="{{ $dhlTrackingUrl }}" target="_blank" rel="noopener noreferrer" class="bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold px-3.5 py-2 rounded-lg transition-colors flex items-center gap-1.5 shadow-sm">
