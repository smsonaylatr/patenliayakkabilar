    ...
    <div class="detail-section" style="flex:1">
      ...
      <div class="detail-addr">
        ...
        @if($order->customer_phone)
            ...
            @endphp
            <div class="td-muted" style="margin-top:2px; display: flex; align-items: center; gap: 8px;">
              {{ $order->customer_phone }}
              <a 
                href="https://wa.me/{{ $rawPhone }}?text={{ urlencode($waMessage) }}" 
                target="_blank" 
                title="WhatsApp ile mesaj at"
                style="display: inline-flex; align-items: center; justify-content: center; width: 26px; height: 26px; border-radius: 50%; background: #25D366; color: #fff; text-decoration: none; transition: all 0.2s ease; flex-shrink: 0;"
                onmouseover="this.style.transform='scale(1.15)'; this.style.boxShadow='0 3px 12px rgba(37,211,102,0.4)';"
