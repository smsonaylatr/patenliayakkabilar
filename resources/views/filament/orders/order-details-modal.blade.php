<div class="space-y-6 text-sm">
    ...
    <div class="bg-gray-50 dark:bg-gray-800/60 p-4 rounded-xl border border-gray-200 dark:border-gray-700/80">
        <h4 class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-3 flex items-center gap-2">
            @svg('heroicon-o-map-pin', 'text-primary-500', ['style' => 'width: 1.25rem; height: 1.25rem; min-width: 1.25rem; flex-shrink: 0; display: inline-block;'])
            <span>Teslimat Adresi & Müşteri Bilgileri</span>
        </h4>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800/40 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
            <h4 class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 flex items-center gap-2">
                @svg('heroicon-o-shopping-bag', 'text-primary-500', ['style' => 'width: 1.25rem; height: 1.25rem; min-width: 1.25rem; flex-shrink: 0; display: inline-block;'])
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
            @forelse($order->items as $item)
                ...
                <div class="p-3.5 flex items-center gap-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                    <!-- Ürün Görseli -->
                    <div class="shrink-0 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800" style="width: 56px; height: 56px; min-width: 56px; min-height: 56px;">
                        <img src="{{ $imageUrl }}" alt="{{ $item->product_name }}" class="w-full h-full object-cover" style="width: 56px; height: 56px; object-fit: cover;">
                    </div>
