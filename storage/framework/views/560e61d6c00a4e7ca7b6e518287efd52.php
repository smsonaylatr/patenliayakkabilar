        ...
        >
                ...
                <div class="w-full h-full relative transition-transform duration-700 ease-in-out"
                    ...
                    <div class="absolute inset-0 w-full h-full bg-gray-50 rounded-2xl overflow-hidden transition-opacity duration-300" 
                        ...
                        <a href="<?php echo e(route('products.show', $product->slug)); ?>" wire:navigate class="block w-full h-full active:scale-95 transition-transform duration-200 origin-center">
                            <img src="<?php echo e($product->images->first() ? asset('storage/' . $product->images->first()->image_path) : 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80'); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-center object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110">
            ...
            <div class="mt-4 flex flex-col items-center justify-center text-center px-2 w-full overflow-hidden">
                ...
                <div class="mt-2 flex items-center justify-center gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price): ?>
                        <span class="text-sm font-bold text-red-600"><?php echo e(number_format($product->discount_price, 2)); ?> ₺</span>
                        <span class="text-xs text-gray-400 line-through decoration-gray-300"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
                    <?php else: ?>
                        <span class="text-sm font-semibold text-gray-700"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\lawire\resources\views/livewire/product/product-grid.blade.php ENDPATH**/ ?>