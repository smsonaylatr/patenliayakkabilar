...
<body class="bg-white text-center p-8">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'success'): ?>
        <script>
            // Parent pencereyi anında başarılı sayfasına yönlendir (bekleme yok)
            window.top.location.replace("<?php echo e(route('order.success', ['order_number' => $order_number ?? 'bilinmiyor'])); ?>");
        </script>
    <?php else: ?>
        ...
        <p class="text-gray-600 mb-4"><?php echo e($reason ?? 'İşlem sırasında bir hata oluştu.'); ?></p>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\payment\paytr-result.blade.php ENDPATH**/ ?>