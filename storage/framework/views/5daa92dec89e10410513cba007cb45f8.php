<div 
    x-data="{ 
        ...
        addRecentToCart(id) {
            Livewire.find('<?php echo e($_instance->getId()); ?>').call('quickAddToCart', id);
                ...
                <div class="shrink-0 flex items-center justify-between px-5 lg:px-12 pt-6 md:pt-8 pb-5 md:pb-6 border-b border-black/[0.06]"
                    ...
                    <div class="flex items-center gap-10">
                        ...
                        <button @click="activeTab = 'cart'" 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($items->sum('quantity') > 0): ?>
                                <span class="absolute font-medium text-xs lg:text-sm leading-none"
                                      style="top: -2px; left: calc(100% + 4px);"><?php echo e($items->sum('quantity')); ?></span>
                            ...
                            <div class="flex-1 overflow-y-auto overscroll-contain px-5 lg:px-12 py-6 lg:py-8" style="scrollbar-width: thin;">
                                <ul class="flex flex-col">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <li class="flex gap-4 md:gap-6 <?php echo e($index > 0 ? 'pt-4 md:pt-6 border-t border-black/[0.06]' : ''); ?> pb-4 md:pb-6">
                                            <!-- Product Image -->
                                            <a href="<?php echo e(route('products.show', $item->product->slug)); ?>" wire:navigate 
                                               class="block shrink-0 grow-0 rounded-lg overflow-hidden" style="width:80px;height:80px;">
                                                <img src="<?php echo e($item->product->images->first() ? $item->product->images->first()->image_url : asset('img/placeholder.svg')); ?>" 
                                            ...
                                            <div class="flex-1 min-w-0 flex flex-col justify-center gap-1">
                                                <a href="<?php echo e(route('products.show', $item->product->slug)); ?>" wire:navigate 
                                                   class="font-medium text-sm leading-tight line-clamp-2"><?php echo e($item->product->name); ?></a>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->variant): ?>
                                                    ...
                                                    ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variantLabel): ?>
                                                    <span class="text-xs text-black/40"><?php echo e($variantLabel); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <span class="text-sm"><?php echo e(number_format($item->price, 2)); ?>TL</span>
                                            </div>

                                            <!-- Quantity & Remove -->
                                            <div class="shrink-0 flex flex-col items-end justify-between" style="min-height:80px;">
                                                <div class="flex items-center justify-center border border-black/10 rounded-lg relative" style="width:80px;height:36px;" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'qty-'.e($item->id).''; ?>wire:key="qty-<?php echo e($item->id); ?>">
                                                    <button wire:click="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity - 1); ?>)" wire:loading.attr="disabled" wire:target="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity - 1); ?>)" class="flex justify-center items-center h-full w-8 text-black/30 hover:text-black active:text-black transition-colors disabled:opacity-20">
                                                    ...
                                                    <span class="text-sm text-center flex-1" wire:loading.class="opacity-30" wire:target="updateQuantity"><?php echo e($item->quantity); ?></span>
                                                    <button wire:click="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity + 1); ?>)" wire:loading.attr="disabled" wire:target="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity + 1); ?>)" class="flex justify-center items-center h-full w-8 text-black/30 hover:text-black active:text-black transition-colors disabled:opacity-20">
                                                ...
                                                <button wire:click="removeItem(<?php echo e($item->id); ?>)" class="p-1.5 text-black/30 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all relative" style="right: 8px;" title="Kaldır" aria-label="Ürünü sepetten kaldır">
                                        ...
                                        <div x-ref="recScroll" class="flex gap-3 overflow-x-auto pb-1 -mx-5 px-5 lg:-mx-12 lg:px-12 snap-x snap-mandatory hide-scrollbar" style="-webkit-overflow-scrolling: touch;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="snap-start shrink-0 flex items-center gap-3 rounded-xl border border-black/[0.06] p-2.5 hover:border-black/15 transition-colors" style="width: 260px;">
                                                    <a href="<?php echo e(route('products.show', $rec->slug)); ?>" wire:navigate class="block shrink-0 rounded-lg overflow-hidden" style="width:64px;height:64px;">
                                                        <img src="<?php echo e($rec->images->first() ? $rec->images->first()->image_url : asset('img/placeholder.svg')); ?>" alt="<?php echo e($rec->name); ?>" width="64" height="64" class="w-full h-full object-cover" loading="lazy">
                                                    </a>
                                                    <div class="flex-1 min-w-0">
                                                        <a href="<?php echo e(route('products.show', $rec->slug)); ?>" wire:navigate class="font-medium text-xs leading-tight line-clamp-2 mb-0.5 block"><?php echo e($rec->name); ?></a>
                                                        <span class="text-xs text-black/60 block mb-1.5"><?php echo e(number_format($rec->discount_price ?? $rec->price, 2)); ?>TL</span>
                                                        <button wire:click="quickAddToCart(<?php echo e($rec->id); ?>)" 
                                ...
                                <div class="px-5 lg:px-12 py-4 lg:py-6" style="padding-bottom: calc(1.5rem + env(safe-area-inset-bottom, 0px));">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-5">
                                        ...
                                        <div class="text-right place-self-end">
                                            ...
                                            <span class="text-lg md:text-2xl font-bold leading-none tracking-tight"><?php echo e(number_format($total, 2)); ?>TL</span>
                                        </div>
                                    </div>

                                    <!-- Action Buttons -->
                                    <div class="grid gap-3">
                                        <a href="<?php echo e(route('checkout')); ?>" @click="open = false" wire:navigate
    ...
    <div x-show="shippingPanel" style="display: none; z-index: 10000;" class="fixed inset-0 cart-bottom-sheet" @keydown.escape.window.stop="shippingPanel = false"
        ...
        <div x-show="shippingPanel" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="translate-y-full" x-transition:enter-end="translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="translate-y-0" x-transition:leave-end="translate-y-full" class="absolute bottom-0 inset-x-0 bg-white rounded-t-2xl md:rounded-t-none px-6 pt-6 pb-[calc(1.5rem+15px+env(safe-area-inset-bottom,0px))] md:pb-8 md:shadow-[-8px_0_40px_rgba(0,0,0,0.08)]">
            ...
            <div x-show="calculated" x-transition.opacity class="flex items-center gap-2 px-4 py-3 bg-green-50 border border-green-200 rounded-xl mt-1">
                ...
                <span class="text-sm text-green-700 font-medium">Ücretsiz kargo · Tahmini <?php echo e($deliveryEstimate); ?></span>
            </div>
        </div>
    </div>
    </template>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\livewire\frontend\cart-drawer.blade.php ENDPATH**/ ?>