...
<?php endif; ?>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 sm:p-10">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 pb-8 border-b border-gray-100">
                    ...
                    <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-emerald-50 text-emerald-700 font-bold hover:bg-emerald-100 transition-colors whitespace-nowrap flex-shrink-0">
                        Ürüne Dön
                    </a>
                </div>
