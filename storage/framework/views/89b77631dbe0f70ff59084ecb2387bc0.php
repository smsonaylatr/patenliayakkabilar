                    ...
                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-2xl rounded-tl-[2rem] rounded-bl-[2rem] sm:rounded-bl-[2rem]">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <li class="flex py-6 group">
                                                <div class="h-28 w-24 flex-shrink-0 overflow-hidden rounded-2xl bg-gray-50 shadow-sm transition-transform duration-300 group-hover:scale-105">
                                                    <img src="<?php echo e($item->product->images->first() ? asset('storage/' . $item->product->images->first()->image_path) : 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'); ?>" alt="<?php echo e($item->product->name); ?>" class="h-full w-full object-contain p-2 object-center">
                                                </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($items) > 0): ?>
                            <div class="border-t border-gray-100 bg-gray-50 px-6 py-6 sm:px-8 rounded-bl-[2rem] pb-10 md:pb-6">
                                ...
                                <div class="mt-4">
                                    <a href="<?php echo e(route('checkout')); ?>" class="relative flex items-center justify-center w-full px-6 py-4 overflow-hidden font-bold text-white bg-black rounded-2xl group transition-all hover:shadow-[0_0_20px_rgba(0,0,0,0.3)] hover:-translate-y-1" wire:navigate>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\lawire\resources\views/livewire/frontend/cart-drawer.blade.php ENDPATH**/ ?>