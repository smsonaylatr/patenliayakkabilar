...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('ogImage', null, []); ?> <?php echo e($product->images->skip(1)->first()?->image_url ?? $product->images->first()?->image_url ?? asset('whatsapp-cover.png')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('ogImageSquare', null, []); ?> <?php echo e($product->images->first()?->image_url ?? asset('og-square.png')); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('canonical', null, []); ?> <?php echo e($product->canonical_url ?? url('/urun/' . $product->slug)); ?> <?php $__env->endSlot(); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($product->is_indexable) && $product->is_indexable === false): ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
     <?php $__env->slot('schema', null, []); ?> 
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(app()->bound(\App\Services\SchemaService::class)): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($product->faq_schema)): ?>
                <?php echo app(\App\Services\SchemaService::class)->faqPage($product->faq_schema); ?>
...
?>
                ...
                <div class="order-2 lg:col-span-1 lg:row-span-2 mt-6 sm:mt-10 lg:mt-0">
                    ...
                    <div class="mt-3 sm:mt-4">
                        <div class="flex items-center gap-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayDiscount): ?>
                                <p class="text-2xl sm:text-3xl font-bold text-red-600"><?php echo e(number_format($displayDiscount, 2)); ?> ₺</p>
                            ...
                            <?php else: ?>
                                <p class="text-2xl sm:text-3xl font-bold text-red-600"><?php echo e(number_format($displayPrice, 2)); ?> ₺</p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$product->inStock()): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->has_installments): ?>
                        <div class="mt-3 sm:mt-4 p-3 sm:p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-emerald-700 text-sm mt-0.5">Bu ürünü tüm kartlara <strong><?php echo e(number_format($installmentPrice, 2)); ?> ₺ x 3 Ay</strong> ödemeyle, peşin fiyatına alabilirsiniz.</p>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->variants->count() > 0): ?>
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showVariantSelector): ?>
                    ...
                    <div class="mt-3 sm:mt-4 p-3 sm:p-3.5 bg-gradient-to-r from-emerald-50 via-teal-50/50 to-white border border-emerald-100 rounded-xl flex items-center gap-3 shadow-xs">
                        ...
                        <div class="flex-1 text-[11px] sm:text-xs">
                            <div class="flex items-center justify-between flex-wrap gap-x-2 gap-y-1">
                                ...
                                <span class="font-extrabold text-emerald-700 bg-white px-2 py-0.5 rounded border border-emerald-200 shadow-2xs whitespace-nowrap"><?php echo e($deliveryTimeText); ?></span>
                            </div>
                            <div class="text-gray-600 mt-1.5 leading-snug">
                                <i class="fa-regular fa-calendar-check text-emerald-600 mr-0.5"></i>
                                Tahmini Teslimat: <strong class="text-gray-900 font-bold whitespace-nowrap"><?php echo e($startFormatted); ?> - <?php echo e($endFormatted); ?></strong> tarihleri arasında
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="pb-4 space-y-3">
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] text-gray-500 mt-0.5">Ürün başı kargo ücreti sadece 1 TL. Türkiye'nin her yerine ortalama <strong><?php echo e($product->delivery_time ? (stripos($product->delivery_time, 'gün') === false ? $product->delivery_time . ' iş günü' : $product->delivery_time) : '1-3 iş günü'); ?></strong> içinde kargoya verilip adrese ulaştırılır.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-4">
...
$__key = 'mobile-reviews-'.$product->id;
$__componentSlots = [];
...
[$__name, $__params] = $__split('product.stock-notification-modal', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-978724737-4', $__key);
        ...
        (function() {
            try {
                const product = {
                    ...
                    price: <?php echo json_encode($productPrice, 15, 512) ?>,
                    image: <?php echo json_encode($productImage, 15, 512) ?>
                };
