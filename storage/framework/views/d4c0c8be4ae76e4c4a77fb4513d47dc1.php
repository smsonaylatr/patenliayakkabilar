    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isActive && $imageUrl): ?>
        <div x-data="sitePopup()" 
            ...
            <div @click.away="closePopup()"
                ...
                <!-- Close Button -->
                <button @click="closePopup()" aria-label="Kapat" class="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-black/20 hover:bg-black/40 text-white transition-colors">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($finalLink): ?>
                    <a href="<?php echo e($finalLink); ?>" class="block w-full h-full">
                        <img src="<?php echo e($finalImage); ?>" alt="Site Pop-up" class="w-full h-auto object-cover block">
                    </a>
                <?php elseif($finalImage): ?>
                    <img src="<?php echo e($finalImage); ?>" alt="Site Pop-up" class="w-full h-auto object-cover block">
