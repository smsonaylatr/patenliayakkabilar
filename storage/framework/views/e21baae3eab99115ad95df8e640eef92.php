...
<div class="min-h-screen bg-brand-light pb-24 lg:py-24 flex justify-center lg:items-center mobile-auth-spacing">
    <div class="container mx-auto px-4 max-w-md">
        ...
        <div class="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-3xl p-8 shadow-[0_30px_60px_rgba(0,0,0,0.08)] relative overflow-hidden">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('status') || $status): ?>
                <div class="mb-4 bg-green-50 border border-green-200 text-green-700 rounded-xl p-4 text-sm font-medium relative z-10">
                    <?php echo e(session('status') ?? $status); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mt-8 relative z-10">
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('login')); ?>" class="text-brand-blue font-bold hover:underline text-sm transition-colors">
                        Giriş Ekranına Dön
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\livewire\auth\forgot-password.blade.php ENDPATH**/ ?>