                            ...
                            <div class="flex items-center justify-between border-b border-gray-100 pb-6">
                                <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-2" id="slide-over-title">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($items->sum('quantity') > 0): ?>
                                        <span class="bg-gray-100 text-gray-600 text-sm font-medium px-2.5 py-0.5 rounded-full"><?php echo e($items->sum('quantity')); ?></span>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <li class="flex py-6 group">
                                                <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-2xl bg-gray-50 shadow-sm transition-transform duration-300 group-hover:scale-105">
                                                    <img src="<?php echo e($item->product->images->first() ? $item->product->images->first()->image_url : asset('img/placeholder.svg')); ?>" alt="<?php echo e($item->product->name); ?>" class="h-full w-full object-cover object-center">
                                                </div>
                                                ...
                                                <div class="ml-4 flex flex-1 flex-col justify-between">
                                                    <div>
                                                        <div class="flex justify-between text-base font-semibold text-gray-900">
                                                            <h3>
                                                                <a href="<?php echo e(route('products.show', $item->product->slug)); ?>" class="hover:text-blue-600 transition-colors" wire:navigate><?php echo e($item->product->name); ?></a>
                                                            </h3>
                                                            <p class="ml-4 font-bold text-red-600 whitespace-nowrap"><?php echo e(number_format($item->price * $item->quantity, 2)); ?> ₺</p>
                                                        </div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->variant): ?>
                                                            <p class="mt-1 text-sm text-gray-500 bg-gray-100 inline-block px-2 py-0.5 rounded-md">Beden: <span class="font-medium"><?php echo e($item->variant->size); ?></span></p>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="flex flex-1 items-end justify-between text-sm mt-4">
                                                        ...
                                                        <div class="flex items-center bg-gray-50 rounded-full border border-gray-200 p-0.5">
                                                            <button wire:click="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity - 1); ?>)" class="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-white hover:shadow-sm transition-all">-</button>
                                                            <span class="w-8 text-center font-medium text-gray-900"><?php echo e($item->quantity); ?></span>
                                                            <button wire:click="updateQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity + 1); ?>)" class="w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-white hover:shadow-sm transition-all">+</button>
                                                        </div>

                                                        <div class="flex">
                                                            <button wire:click="removeItem(<?php echo e($item->id); ?>)" type="button" class="font-medium text-red-500 hover:text-red-600 hover:underline transition-all flex items-center gap-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($items) > 0): ?>
                            <div class="border-t border-gray-100 bg-gray-50 px-6 py-6 sm:px-8 rounded-bl-[2rem] pb-10 md:pb-6">
                                <div class="flex justify-between text-lg font-bold text-gray-900 mb-2">
                                    <p>Ara Toplam</p>
                                    <p class="text-red-600 whitespace-nowrap"><?php echo e(number_format($total, 2)); ?> ₺</p>
                                </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($items->contains(fn($item) => $item->product->has_installments)): ?>
                                ...
                                <div class="mt-2">
                                    <a href="<?php echo e(route('checkout')); ?>" @click="open = false" class="relative flex items-center justify-center w-full px-6 py-4 overflow-hidden font-bold text-white bg-black rounded-2xl group transition-all hover:shadow-[0_0_20px_rgba(0,0,0,0.3)] hover:-translate-y-1" wire:navigate>
