...
<head>
    ...
    <title><?php echo e($title ?? 'Instagram Çekilişi | Patenli Ayakkabılar®'); ?></title>
    <meta name="description" content="<?php echo e($description ?? 'Patenli Ayakkabılar® resmi Instagram çekiliş katılım formu.'); ?>">
    ...
    <footer class="w-full bg-white border-t border-gray-200 py-8 text-xs text-gray-500">
        <div class="max-w-4xl mx-auto px-4 text-center space-y-4 flex flex-col items-center justify-center">
            ...
            <p class="text-gray-500 text-[11px] font-medium pt-2 border-t border-gray-100 w-full max-w-xs sm:max-w-sm">
                © <?php echo e(date('Y')); ?> Patenli Ayakkabılar®. Tüm Hakları Saklıdır.
            </p>
        </div>
    </footer>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\components\layouts\giveaway.blade.php ENDPATH**/ ?>