...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mt-8 relative z-10">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('auth.google')); ?>" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors">
            ...
            <div class="mt-8 text-center relative z-10">
                <p class="text-sm text-gray-500">
                    Hesabınız yok mu? 
                    <a href="<?php echo e(route('register')); ?>" class="font-bold text-brand-dark hover:text-brand-blue transition-colors">Hemen Kayıt Olun</a>
                </p>
            </div>
