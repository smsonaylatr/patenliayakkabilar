<div class="min-h-screen bg-brand-light py-16 lg:py-24 flex items-center justify-center">
        ...
        <div class="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-3xl p-8 shadow-[0_30px_60px_rgba(0,0,0,0.08)] relative overflow-hidden">
            ...
            <form wire:submit="register" class="space-y-5 relative z-10">
                ...
                <div class="space-y-1.5">
                    ...
                    <input wire:model="name" type="text" id="name" class="w-full text-sm bg-gray-50 border <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?> rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:bg-white transition-all text-gray-700" placeholder="Ahmet Yılmaz">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs font-bold ml-1"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input wire:model="email" type="email" id="email" class="w-full text-sm bg-gray-50 border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-1 ring-red-300 <?php else: ?> border-gray-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:bg-white transition-all text-gray-700" placeholder="ornek@email.com">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input wire:model="password" type="password" id="password" class="w-full text-sm bg-gray-50 border <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-1 ring-red-300 <?php else: ?> border-gray-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:bg-white transition-all text-gray-700" placeholder="••••••••">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full bg-brand-dark text-white font-bold text-base rounded-xl py-3 shadow-[0_8px_25px_rgba(31,41,55,0.3)] hover:shadow-[0_12px_35px_rgba(31,41,55,0.4)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center group relative overflow-hidden">
                        ...
                        <span wire:loading wire:target="register" class="relative z-10">
            ...
            <div class="mt-8 text-center relative z-10">
                <p class="text-sm text-gray-500">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="font-bold text-brand-dark hover:text-brand-blue transition-colors">Giriş Yapın</a>
                </p>
            </div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\livewire\auth\register.blade.php ENDPATH**/ ?>