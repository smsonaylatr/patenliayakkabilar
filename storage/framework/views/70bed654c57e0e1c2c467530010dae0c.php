  ...
  <div class="hero-inner">
    ...
    <div class="hero-3d-stage" id="hero-3d-stage"
      ...
      <div class="card-3d card-main" id="hero-main-card"
        ...
        <img src="<?php echo e($mainProduct && $mainProduct->images->first() ? $mainProduct->images->first()->image_url : 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=700&q=90'); ?>" alt="<?php echo e($mainProduct->name ?? 'Nike Air Max'); ?>" />
      </div>

      <!-- Floating card top-right -->
      <div class="card-3d card-sm card-float-1">
        <img src="<?php echo e($subProduct1 && $subProduct1->images->first() ? $subProduct1->images->first()->image_url : 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&q=80'); ?>" alt="<?php echo e($subProduct1->name ?? 'Adidas'); ?>" />
      </div>

      <!-- Floating card bottom-left -->
      <div class="card-3d card-sm card-float-2">
        <img src="<?php echo e($subProduct2 && $subProduct2->images->first() ? $subProduct2->images->first()->image_url : 'https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=400&q=80'); ?>" alt="<?php echo e($subProduct2->name ?? 'New Balance'); ?>" />
      </div>
