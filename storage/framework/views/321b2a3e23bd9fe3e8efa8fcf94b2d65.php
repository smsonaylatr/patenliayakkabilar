    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden p-8 text-center relative">
        ...
        <div class="relative z-10">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
                ...
                <p class="text-2xl font-black text-blue-900"><?php echo e($order_number); ?></p>
            ...
            <div class="flex flex-col gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check()): ?>
                    <a href="<?php echo e(route('account.orders')); ?>" class="w-full bg-transparent hover:bg-gray-50 text-gray-700 font-bold py-4 px-6 rounded-xl transition-all inline-block border border-gray-200">
                        Siparişimi Görüntüle
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('order.tracking', ['order_number' => $order_number])); ?>" class="w-full bg-transparent hover:bg-gray-50 text-gray-700 font-bold py-4 px-6 rounded-xl transition-all inline-block border border-gray-200">
                        Siparişimi Görüntüle
                    </a>
