<div>
    <div class="marquee-container bg-[#6b6b6b] text-white text-[10px] sm:text-xs font-semibold tracking-widest uppercase py-2.5 sm:py-3 overflow-hidden w-full relative">
        <div class="marquee-content flex whitespace-nowrap">
            ...
            <span class="mx-6 sm:mx-12">ÜCRETSİZ KARGO</span>
    ...
    <header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-none">
                                ...
                                <div class="rounded-3xl shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)] bg-white/70 backdrop-blur-2xl border border-white/60 p-3 relative z-10">
                                    <div class="flex flex-col gap-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a href="<?php echo e(route('home')); ?>?category=<?php echo e($category->slug); ?>" class="group flex items-center px-5 py-3.5 text-[13px] text-gray-600 hover:bg-white/60 hover:text-gray-900 rounded-2xl font-bold uppercase tracking-widest transition-all duration-300" wire:navigate>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 pt-2 pb-6 space-y-1">
                <a href="<?php echo e(route('home')); ?>" class="block px-3 py-3 rounded-md text-base font-medium text-gray-900 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>Ana Sayfa</a>
                ...
                <div x-data="{ open: false }" class="space-y-1">
                    ...
                    <div x-show="open" class="pl-4 space-y-1 pb-2" style="display: none;"
                         ...
                         x-transition:enter-end="opacity-100 translate-y-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('home')); ?>?category=<?php echo e($category->slug); ?>" class="block px-3 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>- <?php echo e($category->name); ?></a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>

                <a href="<?php echo e(route('order.tracking')); ?>" class="block px-3 py-3 rounded-md text-base font-medium text-gray-900 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>Sipariş Takip</a>
                <a href="<?php echo e(route('contact')); ?>" class="block px-3 py-3 rounded-md text-base font-medium text-gray-900 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>İletişim</a>
                <a href="<?php echo e(auth()->check() ? route('account.dashboard') : route('login')); ?>" class="block px-3 py-3 rounded-md text-base font-medium text-gray-900 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>Hesabım</a>
            </div>
        </div>
    </header>
</div>
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\lawire\resources\views/livewire/frontend/header.blade.php ENDPATH**/ ?>