        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 sm:h-20 relative">
                ...
                <div class="flex flex-shrink-0 items-center justify-center md:static absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:translate-x-0 md:translate-y-0">
                    <a href="<?php echo e(route('home')); ?>" class="md:hidden text-2xl font-black text-gray-900 tracking-tighter uppercase" wire:navigate>
                        PATENLİ<span class="font-light">AYAKKABILAR&reg;</span>
                    </a>
                    <!-- Desktop Menu -->
                                ...
                                <div class="rounded-3xl shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)] bg-white/70 backdrop-blur-2xl border border-white/60 p-3 relative z-10">
                                    <div class="flex flex-col gap-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a href="<?php echo e(route('category.show', ['slug' => $category->slug])); ?>" class="group flex items-center px-5 py-3.5 text-[13px] text-gray-600 hover:bg-white/60 hover:text-gray-900 rounded-2xl font-bold uppercase tracking-widest transition-all duration-300" wire:navigate>
                ...
                <div class="flex flex-1 items-center justify-end space-x-4 md:space-x-6">
                    ...
                    <a href="<?php echo e(auth()->check() ? route('account.dashboard') : route('login')); ?>" aria-label="Hesabım" class="text-gray-900 hover:text-gray-500 transition-colors hidden sm:flex items-center justify-center p-2 min-w-[44px] min-h-[44px]" title="Hesabım" wire:navigate>
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button wire:click="$dispatch('toggle-cart')" aria-label="Sepetim" class="text-gray-900 hover:text-gray-500 transition-colors relative flex items-center justify-center p-2 min-w-[44px] min-h-[44px]">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cartCount > 0): ?>
                            <span class="absolute top-1 right-1 bg-black text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full"><?php echo e($cartCount); ?></span>
            ...
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <div x-data="{ open: false }" class="space-y-1">
                    ...
                    <div x-show="open" class="pl-4 space-y-1 pb-2" style="display: none;"
                         ...
                         x-transition:enter-end="opacity-100 translate-y-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('category.show', ['slug' => $category->slug])); ?>" @click="mobileMenuOpen = false" class="block px-3 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:text-black hover:bg-gray-50 uppercase tracking-wide" wire:navigate>- <?php echo e($category->name); ?></a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
