    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <div class="flex items-center gap-2 mt-2">
                ...
                <span class="text-sm font-medium text-gray-700"><?php echo e($averageRating); ?> / 5.0</span>
                <span class="text-sm text-gray-400 hidden sm:inline-block">(<?php echo e($totalReviews); ?> Değerlendirme)</span>
            </div>
        </div>
                ...
                <div class="flex justify-between items-start mb-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-400 mt-0.5"><?php echo e($review->created_at->translatedFormat('d F Y')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-4 sm:px-5 space-y-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex justify-center gap-1 text-xl text-yellow-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <button type="button" wire:click="$set('rating', <?php echo e($i); ?>)" class="focus:outline-none transition-transform hover:scale-110 active:scale-95">
