                            ...
                            <div class="aspect-[4/5] bg-gray-100 relative overflow-hidden">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->images->isNotEmpty()): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->images->count() > 1): ?>
                                        <img src="<?php echo e(Storage::url($product->images->skip(1)->first()->image_path)); ?>" 
                                ...
                                <div class="flex items-center justify-between mt-auto">
                                    <div class="flex flex-col">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price): ?>
                                            ...
                                            <span class="text-lg font-black text-red-600 leading-none mt-0.5"><?php echo e(number_format($product->discount_price, 2)); ?> ₺</span>
                                        <?php else: ?>
                                            <span class="text-lg font-black text-gray-900 leading-none"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\lawire\resources\views/livewire/product/best-seller-carousel.blade.php ENDPATH**/ ?>