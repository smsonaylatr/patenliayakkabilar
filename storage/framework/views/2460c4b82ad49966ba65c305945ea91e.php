        ...
        >
            <div class="relative w-full aspect-square bg-transparent rounded-2xl shadow-sm transition-all duration-500 group-hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)]" style="perspective: 1000px;">
                ...
                <div class="absolute inset-0 w-full h-full bg-gray-50 rounded-2xl overflow-hidden">
                    ...
                    <a href="<?php echo e(route('products.show', $product->slug)); ?>" wire:navigate class="block w-full h-full active:scale-95 transition-transform duration-200 origin-center">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->images->isNotEmpty()): ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                            <img src="https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="<?php echo e($product->name); ?> - Patenli Ayakkabı" class="w-full h-full object-center object-cover transition-transform duration-700 ease-out group-hover:scale-105" loading="lazy" width="400" height="400">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div x-show="showSizeModal"
                            ...
                            <div class="flex items-center border-b border-gray-100" style="background-color: #f9fafb; padding: 24px; padding-right: 56px; gap: 16px;">
                                <div class="rounded-xl overflow-hidden bg-white border border-gray-100 flex-shrink-0 shadow-sm" style="width: 64px; height: 64px;">
                                    <img src="<?php echo e($product->images->first() ? $product->images->first()->image_url : 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=150&q=80'); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover">
                                </div>
