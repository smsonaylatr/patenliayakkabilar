    ...
    <div class="bg-gray-50 dark:bg-gray-800/60 p-4 rounded-xl border border-gray-200 dark:border-gray-700/80">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->customer_name ?: 'Belirtilmedi'); ?></span>
            </div>
            
            <div>
                <span class="text-xs text-gray-400 block font-medium">Telefon:</span>
                <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($order->customer_phone ?: 'Belirtilmedi'); ?></span>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <p class="font-medium text-gray-800 dark:text-gray-200 mt-0.5">
                    <?php echo e($order->shipping_address ?: 'Adres girilmemiş'); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->shipping_district || $order->shipping_city): ?>
                        <br><span class="font-bold text-primary-600 dark:text-primary-400"><?php echo e(implode(' / ', array_filter([$order->shipping_district, $order->shipping_city]))); ?></span>
            ...
            <div class="md:col-span-2 bg-amber-50 dark:bg-amber-950/40 p-2.5 rounded-lg border border-amber-200 dark:border-amber-800/50">
                ...
                <p class="text-xs text-amber-900 dark:text-amber-200 italic mt-0.5"><?php echo e($order->customer_note); ?></p>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800/40 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
            <h4 class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 flex items-center gap-2">
                ...
                Sipariş Edilen Ürünler (<?php echo e($order->items->count()); ?>)
            </h4>
        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="p-3.5 flex items-center gap-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                    ...
                    <div class="w-14 h-14 shrink-0 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
                        <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($item->product_name); ?>" class="w-full h-full object-cover">
                    </div>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variantText): ?>
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-primary-50 dark:bg-primary-950/60 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-800/50">
                                    <?php echo e($variantText); ?>

                                </span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span class="text-xs text-gray-500 dark:text-gray-400 font-medium">
                                <?php echo e($item->quantity); ?> Adet × <?php echo e(number_format($item->unit_price, 2)); ?> ₺
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="text-right shrink-0">
                        <span class="font-bold text-gray-900 dark:text-white text-base">
                            <?php echo e(number_format($item->total_price ?: ($item->quantity * $item->unit_price), 2)); ?> ₺
                        </span>
                    </div>
                </div>
        ...
        <div class="bg-gray-50/80 dark:bg-gray-800/60 p-4 border-t border-gray-200 dark:border-gray-800 space-y-1.5 text-xs">
            <div class="flex justify-between text-gray-600 dark:text-gray-400">
                ...
                <span class="font-semibold"><?php echo e(number_format($order->subtotal ?: $order->grand_total, 2)); ?> ₺</span>
            </div>
            ...
            <div class="flex justify-between text-emerald-600 dark:text-emerald-400">
                <span>İndirim:</span>
                <span class="font-semibold">-<?php echo e(number_format($order->discount_total, 2)); ?> ₺</span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->shipping_price > 0): ?>
            <div class="flex justify-between text-gray-600 dark:text-gray-400">
                <span>Kargo Ücreti:</span>
                <span class="font-semibold"><?php echo e(number_format($order->shipping_price, 2)); ?> ₺</span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex justify-between text-sm font-extrabold text-gray-900 dark:text-white pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <span class="text-primary-600 dark:text-primary-400 text-base"><?php echo e(number_format($order->grand_total, 2)); ?> ₺</span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views/filament/orders/order-details-modal.blade.php ENDPATH**/ ?>