...
<div class="min-h-screen bg-gray-50 pt-8 pb-24" x-data="{ activeModal: null }" @open-modal.window="activeModal = $event.detail">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col-reverse lg:flex-row gap-10">
            <!-- Sol Taraf: Form -->
            <div class="flex-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paytr_token): ?>
                    <div class="mb-4">
                    ...
                    <div class="bg-white p-0 sm:p-6 rounded-2xl shadow-sm sm:border sm:border-gray-100">
                        <!-- PayTR Iframe -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment_method === 'wire_transfer'): ?>
                            <div wire:poll.3s="checkOrderStatus">
                                <div wire:ignore>
                                    <iframe x-data x-init="$nextTick(() => { if(typeof iFrameResize !== 'undefined') { iFrameResize({ checkOrigin: false }, $el); } })" src="https://www.paytr.com/odeme/api/<?php echo e($paytr_token); ?>" id="paytriframe" frameborder="0" scrolling="no" style="width: 100%; min-height: 400px; color-scheme: light;"></iframe>
                                </div>
                            </div>
                        <?php else: ?>
                            <div wire:poll.3s="checkOrderStatus">
                                <div wire:ignore>
                                    <iframe x-data x-init="$nextTick(() => { if(typeof iFrameResize !== 'undefined') { iFrameResize({ checkOrigin: false }, $el); } })" src="https://www.paytr.com/odeme/guvenli/<?php echo e($paytr_token); ?>" id="paytriframe" frameborder="0" scrolling="no" style="width: 100%; min-height: 400px; color-scheme: light;"></iframe>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <select wire:model.live="shipping_district" class="w-full px-4 py-3 text-base rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-0 focus:outline-none focus:border-black transition-colors" <?php echo e(empty($districts) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($neighborhoods)): ?>
                                        <div x-data="{
                                            open: false,
                                            search: <?php if ((object) ('shipping_neighborhood') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('shipping_neighborhood'->value()); ?>')<?php echo e('shipping_neighborhood'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('shipping_neighborhood'); ?>')<?php endif; ?>.live,
                                            neighborhoods: <?php echo \Illuminate\Support\Js::from($neighborhoods)->toHtml() ?>,
                                            get filtered() {
                                            ...
                                            <div class="relative">
                                                ...
                                                >
                                                <button type="button" @click="open = !open; if(open) $refs.searchInput.focus()" aria-label="Mahalle Seçimi" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600">
                                    ...
                                    <?php else: ?>
                                        <input type="text" wire:model.blur="shipping_neighborhood" class="w-full px-4 py-3 text-base rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-0 focus:outline-none focus:border-black transition-colors" placeholder="<?php echo e(empty($shipping_district) ? 'Önce ilçe seçiniz...' : 'Mahalle adını yazınız...'); ?>" <?php echo e(empty($shipping_district) ? 'disabled' : ''); ?>>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['shipping_neighborhood'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <!-- Fatura Bilgileri -->
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100" x-data="{ invoiceType: <?php if ((object) ('invoice_type') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('invoice_type'->value()); ?>')<?php echo e('invoice_type'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('invoice_type'); ?>')<?php endif; ?>.live }">
                        <h2 class="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-3" x-data="{ selectedPayment: <?php if ((object) ('payment_method') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('payment_method'->value()); ?>')<?php echo e('payment_method'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('payment_method'); ?>')<?php endif; ?> }">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCodAllowed): ?>
                            <!-- Kapıda Ödeme Seçeneği -->
                            <label class="flex items-start p-4 border rounded-xl cursor-pointer transition-all duration-200" :class="selectedPayment === 'cash_on_delivery' ? 'border-gray-300 bg-gray-50 shadow-sm' : 'border-gray-100 hover:border-gray-200 hover:bg-gray-50/50'">
                                <div class="flex items-center h-5">
                                    <input x-model="selectedPayment" type="radio" value="cash_on_delivery" class="w-5 h-5 text-black border-gray-300 focus:ring-0 focus:outline-none">
                                </div>
                                <div class="ml-3">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mb-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['terms_consent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-4 max-h-[300px] overflow-y-auto pr-3 pt-2 custom-scrollbar">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex gap-4 group" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'checkout-item-'.e($item->id).''; ?>wire:key="checkout-item-<?php echo e($item->id); ?>">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$paytr_token): ?>
                                    <div class="flex-shrink-0 flex flex-col items-end justify-between gap-1">
                                        ...
                                        <div class="flex items-center border border-gray-200 rounded-lg" style="height:32px;">
                                            <button wire:click="updateCartQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity - 1); ?>)" wire:loading.attr="disabled" class="flex items-center justify-center w-7 h-full text-gray-400 hover:text-black active:text-black transition-colors disabled:opacity-20">
                                            ...
                                            <span class="text-xs font-medium text-center w-6" wire:loading.class="opacity-30" wire:target="updateCartQuantity"><?php echo e($item->quantity); ?></span>
                                            <button wire:click="updateCartQuantity(<?php echo e($item->id); ?>, <?php echo e($item->quantity + 1); ?>)" wire:loading.attr="disabled" class="flex items-center justify-center w-7 h-full text-gray-400 hover:text-black active:text-black transition-colors disabled:opacity-20">
                                        ...
                                        <button
                                            type="button"
                                            wire:click="removeCartItem(<?php echo e($item->id); ?>)"
                                            wire:confirm="Bu ürünü sepetten kaldırmak istediğinize emin misiniz?"
                                            wire:loading.attr="disabled"
                                            wire:target="removeCartItem(<?php echo e($item->id); ?>)"
                                            class="p-1 rounded text-gray-400 hover:text-red-500 transition-colors"
                                            title="Kaldır"
                                            aria-label="Ürünü sepetten kaldır"
                                        >
                                            <svg wire:loading.remove wire:target="removeCartItem(<?php echo e($item->id); ?>)" class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                                            <svg wire:loading wire:target="removeCartItem(<?php echo e($item->id); ?>)" class="w-3.5 h-3.5 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                                        </button>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($applied_coupon): ?>
                            <div class="flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="text-sm font-bold text-emerald-800"><?php echo e($applied_coupon->code); ?></span>
                                        <span class="text-xs text-emerald-600 block">-<?php echo e(number_format($coupon_discount, 2)); ?> ₺ indirim</span>
                                    </div>
                                </div>
                        ...
                        <?php else: ?>
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse x-cloak class="mt-3">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coupon_error): ?>
                                        <p class="text-xs text-red-500 mt-2 flex items-center gap-1">
                                            ...
                                            <?php echo e($coupon_error); ?>

                                        </p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coupon_message): ?>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-100 space-y-3">
                        ...
                        <div class="flex justify-between text-sm text-emerald-600">
                            ...
                            <span class="font-medium">-<?php echo e(number_format($couponDiscount, 2)); ?> ₺</span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex justify-between text-sm text-gray-600">
                            <span>Kargo <span class="text-[10px] text-gray-400 ml-1"><?php echo e($payment_method === 'cash_on_delivery' ? '(200 ₺ Hizmet Bedeli + Ürün Başı 1 ₺)' : '(Ürün Başı 1 ₺)'); ?></span></span>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="activeModal === 'on-bilgilendirme'" 
                ...
                <div class="flex justify-between items-center pb-4 border-b border-gray-100 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('pages.show', 'on-bilgilendirme-formu')); ?>" target="_blank" class="text-xs font-bold text-teal-600 hover:underline flex items-center gap-1">
                            Tam Sayfa
            ...
            <div x-show="activeModal === 'mesafeli-sozlesme'" 
                ...
                <div class="flex justify-between items-center pb-4 border-b border-gray-100 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('pages.show', 'mesafeli-satis-sozlesmesi')); ?>" target="_blank" class="text-xs font-bold text-teal-600 hover:underline flex items-center gap-1">
                            Tam Sayfa
                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
        <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'error-scroller-'.e(Str::random()).''; ?>wire:key="error-scroller-<?php echo e(Str::random()); ?>" x-data x-init="
            $nextTick(() => {
                setTimeout(() => {
