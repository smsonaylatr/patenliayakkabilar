...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Patenli Ayakkabılar | Tekerlekli Ayakkabı Modelleri <?php $__env->endSlot(); ?>
                    ...
                    <div class="relative">
                        <div class="relative mb-5">
                            <div class="flex items-center justify-between gap-3">
                                <h2 class="text-xl sm:text-2xl md:text-3xl font-black text-gray-900 tracking-tight leading-none"><?php echo e($category->name); ?></h2>
                                <a href="<?php echo e(route('category.show', ['slug' => $category->slug])); ?>" wire:navigate class="group inline-flex items-center gap-2 text-sm sm:text-[15px] font-medium text-gray-800 hover:text-black transition-colors shrink-0">
                                    Daha Fazla 
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-125635806-0', $__key);
