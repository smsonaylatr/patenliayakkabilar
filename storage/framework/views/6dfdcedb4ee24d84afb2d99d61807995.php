...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="max-w-3xl">
        <h1 class="text-3xl font-black text-gray-900 mb-2">Hoş Geldiniz, <?php echo e(auth()->user()->name); ?></h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            <!-- Orders Card -->
            <a href="<?php echo e(route('account.orders')); ?>" class="group flex flex-col p-8 bg-white border border-gray-100 rounded-3xl hover:border-black hover:shadow-xl transition-all duration-300">
            ...
            <!-- Settings Card -->
            <a href="<?php echo e(route('account.profile')); ?>" class="group flex flex-col p-8 bg-white border border-gray-100 rounded-3xl hover:border-black hover:shadow-xl transition-all duration-300">
                <div class="w-12 h-12 bg-gray-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-black group-hover:text-white transition-colors duration-300">
...
<?php endif; ?>
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\livewire\account\dashboard.blade.php ENDPATH**/ ?>