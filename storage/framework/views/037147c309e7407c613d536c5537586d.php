...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3552557477-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3552557477-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3552557477-2', $__key);
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                        <div class="col-span-2">
                            ...
                            <p class="text-gray-400 max-w-md"><?php echo e($footerDesc); ?></p>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3552557477-3', $__key);
        ...
        <div x-data="{ open: false }" 
            ...
            <div x-show="open" 
                 ...
                 <div class="px-6 py-8 border-b border-gray-100 flex flex-col justify-between relative">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('products.index')); ?>" @click="open = false" wire:navigate class="inline-flex text-[11px] font-black text-gray-900 uppercase tracking-[0.2em] items-center gap-1.5 border-b-2 border-gray-900 pb-0.5 hover:text-brand-orange hover:border-brand-orange transition-colors">
                            TÜM ÜRÜNLER
                 ...
                 <div class="flex-1 overflow-y-auto px-6 py-2 pb-24">
                    ...
                    <ul class="flex flex-col">
                        ...
                        <li class="border-b border-gray-100 last:border-0">
                            <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>" @click="open = false" wire:navigate class="flex items-center justify-between py-6 group">
                                <div class="flex items-center gap-5 sm:gap-8">
                                    ...
                                    <span class="text-3xl sm:text-4xl font-black text-gray-900 group-hover:text-brand-orange transition-colors tracking-tight"><?php echo e($category->name); ?></span>
                                </div>
