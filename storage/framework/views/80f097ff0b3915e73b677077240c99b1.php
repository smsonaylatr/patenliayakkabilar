<div class="bg-brand-dark py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <form wire:submit.prevent="subscribe" class="flex flex-col sm:flex-row gap-4 justify-center">
            <input type="email" wire:model="email" aria-label="E-posta adresiniz" placeholder="E-posta adresiniz..." required class="px-6 py-4 rounded-xl flex-grow max-w-md focus:ring-2 focus:ring-brand-orange outline-none">
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\livewire\frontend\newsletter-form.blade.php ENDPATH**/ ?>