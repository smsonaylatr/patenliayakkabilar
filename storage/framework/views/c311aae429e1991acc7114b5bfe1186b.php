    ...
    <div class="min-h-[70vh] bg-gray-50 py-6 sm:py-12 px-3 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 text-center">
                ...
                <form action="<?php echo e(route('order.tracking')); ?>" method="GET" class="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                    <div>
                        <input type="text" name="order_number" value="<?php echo e(request('order_number')); ?>" class="w-full rounded-xl border-gray-200 focus:ring-black focus:border-black text-center text-base sm:text-lg py-2.5 sm:py-3 uppercase tracking-wider font-semibold" placeholder="Örn: TR123456" required>
                    </div>
                    ...
                    <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-100 text-left">
                        ...
                        <div class="bg-gray-50 rounded-xl sm:rounded-2xl p-3.5 sm:p-5 space-y-3 sm:space-y-4 border border-gray-100">
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                                ...
                                <div x-data="{ copied: false }" @click="navigator.clipboard.writeText('<?php echo e(e($order->order_number)); ?>'); copied = true; setTimeout(() => copied = false, 2000)" class="cursor-pointer inline-flex items-center gap-1.5 bg-white px-3 py-1 rounded-lg border border-gray-200 text-xs sm:text-sm font-semibold text-gray-900 hover:border-black transition-colors self-start sm:self-auto" title="Tıklayarak Kopyala">
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-0">
                                ...
                                <span class="font-medium text-gray-900 text-xs sm:text-sm"><?php echo e($order->created_at->format('d.m.Y H:i')); ?></span>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-0">
                                ...
                                <span class="font-medium text-gray-900 text-xs sm:text-sm">
                                    <?php echo e($order->payment_method === 'cash_on_delivery' ? 'Kapıda Ödeme' : ($order->payment_method === 'credit_card' ? 'Kredi Kartı' : 'Havale / EFT')); ?>
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1.5 sm:gap-0">
                                ...
                                <div>
                                    ...
                                    <?php elseif($order->payment_status === 'pending'): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payment_method === 'cash_on_delivery'): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="bg-gray-100 text-gray-800 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider"><?php echo e($order->payment_status ?? 'Bilinmiyor'); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>

                            <!-- KARGO TAKİP KODU VE FİRMA BİLGİSİ ALANI -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRealTrackingCode): ?>
                                <div class="bg-white p-3 sm:p-4 rounded-xl border border-gray-200 space-y-3 mt-2 shadow-xs">
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-2 pt-1 border-b border-gray-100 pb-3">
                                        <div class="min-w-0 flex-1">
                                            <div class="font-mono font-black text-black text-lg sm:text-xl tracking-wider break-all"><?php echo e($trackingCode); ?></div>
                                            ...
                                            <div class="flex items-center gap-2 mt-1.5">
                                                ...
                                                <div class="flex items-center gap-1.5">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cargoLogo): ?>
                                                        <img src="<?php echo e($cargoLogo); ?>" alt="<?php echo e($cargoName); ?>" class="h-4 object-contain">
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <strong class="text-gray-900 font-semibold text-xs"><?php echo e($cargoName); ?></strong>
                                                </div>
                                            </div>
                                        </div>
                                        <div x-data="{ copied: false }" @click="navigator.clipboard.writeText('<?php echo e(e($trackingCode)); ?>'); copied = true; setTimeout(() => copied = false, 2000)" class="cursor-pointer bg-gray-100 hover:bg-black hover:text-white text-gray-800 text-xs font-bold px-3.5 py-2 rounded-lg transition-colors flex items-center justify-center gap-1.5 shadow-xs shrink-0 w-full sm:w-auto">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trackingUrl): ?>
                                    <div class="pt-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                                        ...
                                        <a href="<?php echo e($trackingUrl); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-1.5 text-xs font-bold text-blue-600 hover:text-blue-800 hover:underline bg-blue-50 px-3 py-2 sm:py-1.5 rounded-lg transition-colors w-full sm:w-auto">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deliveryDate || $deliveryLocation || $cargoMessage): ?>
                                <div class="bg-emerald-50/70 p-3 sm:p-4 rounded-xl border border-emerald-200/80 mt-3 space-y-3 shadow-xs">
                                    ...
                                    <div class="space-y-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deliveryDate): ?>
                                            <div>
                                                <div class="text-xs text-emerald-700/80 font-semibold uppercase">TESLİM TARİHİ</div>
                                                <div class="text-emerald-900 font-bold text-xs sm:text-sm"><?php echo e($deliveryDate); ?></div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deliveryLocation): ?>
                                            <div>
                                                <div class="text-xs text-emerald-700/80 font-semibold uppercase">TESLİM LOKASYONU</div>
                                                <div class="text-emerald-900 font-bold text-xs sm:text-sm uppercase"><?php echo e($deliveryLocation); ?></div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cargoMessage): ?>
                                            <div>
                                                <div class="text-xs text-emerald-700/80 font-semibold uppercase">KARGO MESAJI</div>
                                                <div class="text-emerald-900 font-bold text-xs sm:text-sm"><?php echo e($cargoMessage); ?></div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-red-50/70 p-3 sm:p-4 rounded-xl border border-red-200/80 space-y-2.5 mt-2">
                                        ...
                                        <div class="pt-1">
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cancelSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="flex-1 flex flex-col items-center">
                                                        <div class="w-full rounded-full h-1.5" style="background-color: #e5e7eb;">
                                                            <div class="h-1.5 rounded-full" style="width: 100%; background-color: <?php echo e($step['color']); ?>;"></div>
                                                        </div>
                                                        <span class="text-[10px] mt-1 font-semibold" style="color: <?php echo e($step['done'] ? $step['color'] : '#9ca3af'); ?>;"><?php echo e($step['label']); ?></span>
                                                    </div>
                                    ...
                                    <div class="pt-1">
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="flex-1 flex flex-col items-center">
                                                    <div class="w-full rounded-full h-1.5" style="background-color: #e5e7eb;">
                                                        <div class="h-1.5 rounded-full" style="width: 100%; background-color: <?php echo e($step['done'] ? '#f97316' : '#e5e7eb'); ?>;"></div>
                                                    </div>
                                                    <span class="text-[10px] mt-1 font-semibold" style="color: <?php echo e($step['done'] ? '#c2410c' : '#9ca3af'); ?>;"><?php echo e($step['label']); ?></span>
                                                </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="flex justify-between items-center border-t border-gray-200 pt-3">
                                ...
                                <span class="font-black text-gray-900 text-sm sm:text-base">₺<?php echo e(number_format($order->grand_total, 2, ',', '.')); ?></span>
                            </div>
                        </div>

                        <!-- Ürünler Listesi -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->items->isNotEmpty()): ?>
                                        ...
                                        <div class="flex items-center p-2.5 sm:p-3.5 bg-gray-50 rounded-xl border border-gray-100 text-sm gap-3 sm:gap-4">
                                            ...
                                            <div class="bg-white rounded-lg overflow-hidden border border-gray-200 shrink-0" style="width: 72px; height: 72px; min-width: 72px;">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($imageUrl): ?>
                                                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($item->product_name); ?>" style="width: 100%; height: 100%; object-fit: cover;" loading="lazy">
                                                <?php else: ?>
                                            ...
                                            <div class="flex-1 min-w-0 flex flex-col justify-between gap-1" style="min-height: 72px;">
                                                <div>
                                                    <div class="font-bold text-gray-900 text-xs sm:text-sm leading-tight line-clamp-2"><?php echo e($item->product_name); ?></div>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->variant_info): ?>
                                                        <div class="text-[11px] sm:text-xs text-gray-500 mt-0.5 truncate"><?php echo e($item->variant_info); ?></div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span class="font-bold text-gray-900 text-xs sm:text-sm"><?php echo e($item->quantity); ?> adet</span>
                                                    <div class="text-xs sm:text-sm font-bold text-gray-900">₺<?php echo e(number_format($item->unit_price ?: 0, 2, ',', '.')); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
