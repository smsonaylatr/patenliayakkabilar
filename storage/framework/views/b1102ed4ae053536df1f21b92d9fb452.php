...
<div class="newsletter-bar" id="floatingSidebar">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($sidebarSettings['footer_facebook']) || !empty($sidebarSettings['footer_instagram'])): ?>
    <div class="newsletter-bar__social">
        <ul role="list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($sidebarSettings['footer_facebook'])): ?>
            <li>
                <a target="_blank" rel="noopener noreferrer" href="<?php echo e($sidebarSettings['footer_facebook']); ?>" class="social_platform" aria-label="Facebook">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($sidebarSettings['footer_instagram'])): ?>
            <li>
                <a target="_blank" rel="noopener noreferrer" href="<?php echo e($sidebarSettings['footer_instagram']); ?>" class="social_platform" aria-label="Instagram">
                    <svg viewBox="0 0 24 24" stroke="none" fill="currentColor" xmlns="http://www.w3.org/2000/svg" role="presentation">
    ...
    <a href="<?php echo e(route('products.index')); ?>" class="newsletter-bar__button" wire:navigate>
        <span>%5 İNDİRİM</span>
    </a>
</div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\patenliayakkabilar.com\resources\views\components\frontend\floating-sidebar.blade.php ENDPATH**/ ?>