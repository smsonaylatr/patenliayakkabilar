...
<html lang="tr" dir="ltr">
    <head>
     ...
     crossorigin="anonymous"></script>
        ...
        <link rel="icon" type="image/png" href="/favicon.png?v=<?php echo e(time()); ?>">
        <link rel="apple-touch-icon" href="/favicon.png?v=<?php echo e(time()); ?>">
        <link rel="icon" type="image/png" sizes="192x192" href="/favicon.png?v=<?php echo e(time()); ?>">
        <link rel="icon" type="image/png" sizes="512x512" href="/favicon.png?v=<?php echo e(time()); ?>">
        ...
        <title><?php echo e($title ?? 'Patenli Ayakkabılar | Tekerlekli Ayakkabı Modelleri'); ?></title>
        ...
        <meta property="og:title" content="<?php echo e($title ?? 'Patenli Ayakkabılar'); ?>">
        <meta property="og:description" content="<?php echo e($description ?? 'Işıklı ve tekerlekli ayakkabı modelleri'); ?>">
        <meta property="og:image" content="<?php echo e($ogImage ?? asset('whatsapp-cover.png?v=' . time())); ?>">
        <meta property="og:image:width" content="1200">
        <meta property="og:image:height" content="630">

        <!-- Open Graph / WhatsApp (Kare Önizleme) -->
        <meta property="og:image" content="<?php echo e($ogImageSquare ?? asset('og-square.png?v=' . time())); ?>">
        ...
        <meta name="twitter:title" content="<?php echo e($title ?? 'Patenli Ayakkabılar'); ?>">
        <meta name="twitter:description" content="<?php echo e($description ?? 'Işıklı ve tekerlekli ayakkabı modelleri'); ?>">
        <meta name="twitter:image" content="<?php echo e($ogImage ?? asset('whatsapp-cover.png')); ?>">
...
?>
        ...
        <main class="flex-grow page-transition-effect">
            ...
            <div class="bg-white border-y border-gray-200 py-2 sm:py-5 md:py-7 overflow-hidden w-full relative">
                <div class="marquee-content flex whitespace-nowrap items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 24; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <span class="text-black font-black text-xs sm:text-2xl md:text-3xl tracking-[0.15em] sm:tracking-[0.2em] uppercase mx-2.5 sm:mx-6 md:mx-12">HER YERDE KAY</span>
            ...
            ?>
            <footer class="bg-brand-black text-brand-white pt-8 sm:pt-14 pb-24 md:pb-8">
                <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 sm:gap-8 mb-8 sm:mb-12">
                        <div class="col-span-2">
                            <a href="<?php echo e(route('home')); ?>" class="text-xl sm:text-2xl font-black text-white tracking-tighter mb-2.5 sm:mb-4 inline-block" wire:navigate>
                                PATENLİ<span class="font-light">AYAKKABILAR&reg;</span>
                            </a>
                            <p class="text-xs sm:text-sm text-gray-400 max-w-md leading-relaxed"><?php echo e($footerDesc); ?></p>
                            
                            <!-- Social Icons -->
                            <div class="mt-4 sm:mt-5 flex items-center space-x-3 sm:space-x-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_whatsapp'])): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $footerSettings['footer_whatsapp'])); ?>" aria-label="WhatsApp" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_instagram'])): ?>
                                <a href="<?php echo e($footerSettings['footer_instagram']); ?>" aria-label="Instagram" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clip-rule="evenodd" /></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_tiktok'])): ?>
                                <a href="<?php echo e($footerSettings['footer_tiktok']); ?>" aria-label="TikTok" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-4.5 w-4.5 sm:h-5 sm:w-5 mt-0.5" fill="currentColor" viewBox="0 0 448 512" aria-hidden="true"><path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.9 162.9 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z"/></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_facebook'])): ?>
                                <a href="<?php echo e($footerSettings['footer_facebook']); ?>" aria-label="Facebook" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_twitter'])): ?>
                                <a href="<?php echo e($footerSettings['footer_twitter']); ?>" aria-label="Twitter" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-4.5 w-4.5 sm:h-5 sm:w-5 mt-0.5" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($footerSettings['footer_youtube'])): ?>
                                <a href="<?php echo e($footerSettings['footer_youtube']); ?>" aria-label="YouTube" target="_blank" class="text-gray-400 hover:text-brand-orange transition-colors">
                                    <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" clip-rule="evenodd" /></svg>
                                </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>

                            <!-- ETBIS Seal (Dedicated Row) -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.etbis.site_id')): ?>
                            <div class="mt-4 sm:mt-5">
                                <a href="https://etbis.ticaret.gov.tr/tr/SiteSorgulamaSonuc?siteId=<?php echo e(config('services.etbis.site_id')); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2.5 group bg-white/[0.04] hover:bg-white/[0.08] border border-gray-800 hover:border-gray-700 rounded-lg py-1.5 px-3 transition-colors">
                                    <div class="bg-emerald-500/10 p-1 sm:p-1.5 rounded-md flex-shrink-0 group-hover:bg-emerald-500/20 transition-colors">
                                    ...
                                    <div class="flex flex-col text-left">
                                        <div class="flex items-center gap-1.5">
                                            <span class="text-[11px] sm:text-xs font-black text-white tracking-wider leading-none">ETBİS</span>
                                            <span class="text-[8px] sm:text-[9px] font-semibold text-emerald-400 bg-emerald-500/10 px-1 py-0.5 rounded leading-none">Kayıtlı</span>
                                        </div>
                                        <span class="text-[9px] sm:text-[10px] font-medium text-gray-400 leading-none mt-1">Güvenli E-Ticaret</span>
                                    </div>
                                </a>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            <h4 class="text-sm sm:text-lg font-bold mb-2.5 sm:mb-4 text-white">Hızlı Menü</h4>
                            <ul class="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-400">
                                ...
                                <li><a href="<?php echo e(route('pages.show', 'beden-rehberi')); ?>" class="hover:text-brand-orange transition-colors" wire:navigate>Beden Rehberi</a></li>
                                <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-brand-orange transition-colors" wire:navigate>İletişim</a></li>
                            </ul>
                        </div>

                        <div>
                            <h4 class="text-sm sm:text-lg font-bold mb-2.5 sm:mb-4 text-white">Kurumsal</h4>
                            <ul class="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-400">
                                ...
                                <li><a href="<?php echo e(route('pages.show', 'on-bilgilendirme-formu')); ?>" class="hover:text-brand-orange transition-colors" wire:navigate>Ön Bilgilendirme Formu</a></li>
        ...
        <div class="md:hidden fixed inset-x-0 bottom-0 w-full bg-white border-t border-gray-100 z-[9999] rounded-t-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style="padding-bottom: env(safe-area-inset-bottom); transform: translateZ(0);">
            <div>
                <div class="grid grid-cols-6 h-[66px] w-full px-2 py-1.5">
                    ...
                    <a href="<?php echo e(route('home')); ?>" wire:navigate class="flex flex-col items-center justify-center gap-[6px] text-gray-800 active:text-black transition-colors">
                    ...
                    <a href="<?php echo e(auth()->check() ? route('account.dashboard') : route('login')); ?>" wire:navigate class="flex flex-col items-center justify-center gap-[6px] text-gray-800 active:text-black transition-colors">
                        <svg class="w-[22px] h-[22px]" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" xmlns="http://www.w3.org/2000/svg">
...
?>
                ...
                <div x-show="open" 
                    ...
                    <div class="flex flex-col h-full bg-white rounded-t-[24px] overflow-hidden shadow-[0_-8px_40px_rgba(0,0,0,0.08)]"
                        ...
                        <div class="shrink-0 px-5 pt-4 pb-5 border-b border-black/[0.06] flex items-start justify-between"
                             @touchstart="startDrag($event)" @touchmove.prevent="onDrag($event)">
                            <div>
                                <p class="text-[11px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">KOLEKSİYON / <?php echo e(date('Y')); ?></p>
                                <h2 class="text-2xl font-black text-gray-900 tracking-tighter">Katalog</h2>
                            </div>
                            <a href="<?php echo e(route('products.index')); ?>" @click="open = false" wire:navigate class="inline-flex text-[11px] font-black text-gray-900 uppercase tracking-[0.15em] items-center gap-1.5 border-b-2 border-gray-900 pb-0.5 hover:text-brand-orange hover:border-brand-orange transition-colors mt-3">
                                TÜM ÜRÜNLER
                        ...
                        <div class="flex-1 overflow-y-auto px-5 py-2 pb-24">
                            ...
                            <ul class="flex flex-col">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li class="border-b border-gray-100 last:border-0">
                                    <a href="<?php echo e(route('category.show', ['slug' => $category->slug])); ?>" @click="open = false" wire:navigate class="flex items-center justify-between py-5 group">
                                        <div class="flex items-center gap-4">
                                            <span class="text-sm font-bold text-gray-300 w-6"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></span>
                                            <span class="text-2xl font-black text-gray-900 group-hover:text-brand-orange transition-colors tracking-tight"><?php echo e($category->name); ?></span>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <span class="text-[11px] font-extrabold text-gray-400 uppercase tracking-widest whitespace-nowrap"><?php echo e($category->products_count); ?> ÜRÜN</span>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($callWidgetActive === '1'): ?>
        <style>
            .call-widget {
                position: fixed;
                z-index: 50;
        ...
        <a href="tel:08503073164" class="call-widget group" aria-label="Bizi Arayın">
            <svg class="w-5 h-5 animate-[pulse_2s_ease-in-out_infinite]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
        ...
        <div x-data="{ show: false, message: '', type: 'warning' }"
             <?php echo $__env->yieldSection(); ?>-notification.window="message = $event.detail.message; type = $event.detail.type || 'warning'; show = true; setTimeout(() => show = false, 4000)"
             x-show="show"
        ...
        <?php echo $__env->make('components.frontend.floating-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </body>
</html>
