                                        ...
                                        <li>
                                            <a href="<?php echo e(route('products.show', $product->slug)); ?>" wire:navigate class="flex items-center gap-4 rounded-xl p-2 hover:bg-gray-50 transition-colors group">
                                                <div class="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg bg-gray-100">
                                                    <img src="<?php echo e($product->images->first() ? asset('storage/' . $product->images->first()->image_path) : 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80'); ?>" alt="<?php echo e($product->name); ?>" class="h-full w-full object-cover object-center group-hover:scale-105 transition-transform duration-300">
                                                </div>
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="mt-1 flex items-center gap-2">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price): ?>
                                                            <span class="text-sm font-bold text-brand-orange"><?php echo e(number_format($product->discount_price, 2)); ?> ₺</span>
                                                            <span class="text-xs text-gray-400 line-through"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
                                                        <?php else: ?>
                                                            <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Projelerim\lawire\resources\views/livewire/frontend/search-modal.blade.php ENDPATH**/ ?>