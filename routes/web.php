...
Route::get('/run-migrations', function () {
    ...
    $pages = [
        ...
        'mesafeli-satis-sozlesmesi' => [
            ...
            'content' => '<h2>Madde 1 - Taraflar</h2><p>İşbu sözleşme, bir tarafta patenliayakkabilar.com web sitesini işleten Satıcı ile diğer tarafta site üzerinden sipariş veren Alıcı (Müşteri) arasında dijital ortamda onaylanarak yürürlüğe girmiştir.</p><h2>Madde 2 - Konu</h2><p>İşbu sözleşmenin konusu, Alıcı\'nın Satıcı\'ya ait web sitesinden elektronik ortamda siparişini yaptığı aşağıda nitelikleri ve satış fiyatı belirtilen ürünün satışı ve teslimi ile ilgili olarak 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği hükümleri gereğince tarafların hak ve yükümlülüklerinin saptanmasıdır.</p><h2>Madde 3 - Teslimat Süresi ve Şartları</h2><p>Sipariş konusu ürün/ürünler, Alıcı\'nın sipariş formunda belirttiği teslimat adresine, faturası ile birlikte paketlenmiş ve sağlam olarak, yasal 30 günlük süreyi aşmamak koşuluyla <strong>ortalama 1-3 iş günü</strong> içerisinde kargo firmasına teslim edilir ve Alıcı\'ya ulaştırılır. (Ürün detay sayfasında belirtilen özel teslimat süreleri saklıdır.) Kargo firmasından kaynaklanan gecikmelerden Satıcı sorumlu tutulamaz.</p><h2>Madde 4 - Cayma Hakkı</h2><p>Alıcı, ürünü teslim aldığı tarihten itibaren 14 gün içerisinde hiçbir gerekçe göstermeksizin iade etme hakkına sahiptir.</p>'
        ],
        'on-bilgilendirme-formu' => [
            'title' => 'Ön Bilgilendirme Formu',
            'content' => '<h2>1. Satıcı Bilgileri</h2><p>Unvanı: Patenli Ayakkabılar<br>E-posta: destek@patenliayakkabilar.com<br>Müşteri Hizmetleri: 0850 123 45 67</p><h2>2. Sözleşme Konusu Ürün ve Ödeme</h2><p>Siparişe konu ürünün türü, miktarı, marka/modeli, rengi ve tüm vergiler dahil satış fiyatı siparişin sonlandırıldığı ekranda ve Alıcı\'ya gönderilen sipariş onay e-postasında belirtildiği gibidir.</p><h2>3. Ortalama Teslimat Süresi ve Kargo Şartları</h2><p>Sipariş verilen ürünler, yasal 30 günlük süreyi aşmamak kaydıyla <strong>ortalama 1-3 iş günü</strong> (ürün sayfasında özel teslimat süresi belirtilen ürünler için ilgili süre geçerlidir) içerisinde anlaşmalı kargo firmasına teslim edilerek Alıcı\'nın adresine ulaştırılır. Hafta sonu ve resmi tatillerde verilen siparişler takip eden ilk iş günü işleme alınır.</p><h2>4. Cayma Hakkı</h2><p>Alıcı, malı teslim aldığı tarihten itibaren 14 gün içerisinde hiçbir hukuki ve cezai sorumluluk üstlenmeksizin malı reddederek sözleşmeden cayma hakkına sahiptir.</p>'
        ],
...
<html>
<head>
    <title>API Dokümantasyonu - Patenli Ayakkabılar</title>
    <meta charset="utf-8"/>
