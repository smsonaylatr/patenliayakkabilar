            ...
            ->columns([
                \Filament\Tables\Columns\Layout\Split::make([
                    TextColumn::make('customer_name')
                        ...
                        ->limit(24)
                        ->extraAttributes(['style' => 'width: 280px; flex: 0 0 280px; text-align: left; justify-content: flex-start;']),
                    TextColumn::make('shipping_city')
                        ->label('ŞEHİR')
                        ->getStateUsing(fn (Order $record) => $record->shipping_city ?: ($record->billing_city ?: 'İstanbul'))
                        ->limit(16)
                        ->extraAttributes(['style' => 'width: 80px; flex: 0 0 80px; text-align: left; justify-content: flex-start;']),
                    ...
                    TextColumn::make('payment_method')
                        ...
                        ->extraAttributes(['style' => 'width: 106px; flex: 0 0 106px; text-align: left; justify-content: flex-start;']),
                    TextColumn::make('created_at')
                        ...
                        ->extraAttributes(['style' => 'width: 172px; flex: 0 0 172px; text-align: left; justify-content: flex-start;']),
