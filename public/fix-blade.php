<?php
/**
 * Emergency fix script - fixes corrupted blade files
 * Access via: https://patenliayakkabilar.com/fix-blade.php
...
// Fix show.blade.php
$showBlade = $basePath . 'resources/views/products/show.blade.php';
$showContent = '<x-layouts.app>
...
file_put_contents($showBlade, $showContent);
...
echo "✅ show.blade.php FIXED (" . strlen($showContent) . " bytes written)\n";
echo "✅ View cache cleared (" . count($files ?? []) . " compiled views removed)\n";
echo "\n⚠️ DELETE THIS FILE NOW: rm public/fix-blade.php\n";
